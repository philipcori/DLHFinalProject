    ...
    def output(self):
        with open(self.file_path, 'r') as f:
            ...
            with open(self.wfile_path, 'w') as f:
                ...
                csv_writer.writerow(['Type', 'COVID-19', 'pneumonia_virus', 'pneumonia_bacteria'])
            ...
            plt.plot(fpr_0, tpr_0, color='red',
                     lw=2, label='Covid-19 (AUC = %0.4f)' % roc_auc_0)
            plt.plot(fpr_1, tpr_1, color='black',
                     lw=2, label='Pneumonia Virus (AUC = %0.4f)' % roc_auc_1)
            plt.plot(fpr_2, tpr_2, color='orange',
                     lw=2, label='Pneumonia Bacteria (AUC = %0.4f)' % roc_auc_2)
